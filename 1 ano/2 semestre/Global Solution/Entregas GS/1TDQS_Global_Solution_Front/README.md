...
Este é um projeto front-end desenvolvido com [Next.js](https://nextjs.org/) e estilizado utilizando [Tailwind CSS](https://tailwindcss.com/). Ele serve como base comum para aplicações da equipe 1TDSQ da SomosMais. Para esse projeto foram desenvolvidos um WEB APP para usuários (pessoas em vunerabilidade, ocasionados por desastres naturais, precisando de auxílios) e um WEB APP para empresas (ONGs ou empresas que buscam auxiliar as pessoas em vunerabilidade, ocasionados por desastres naturais)
...
###  VERCEL
* WEB APP USUÁRIO: https://1-tdsq-front-comum-t5ae.vercel.app/
* WEB APP EMPRESA: https://1-tdsq-front-empresa-ckak.vercel.app/
...
1. **Clone os repositórios:**
   ...
   ```bash
   git clone https://github.com/SomosMais/1TDSQ-FRONT-COMUM
